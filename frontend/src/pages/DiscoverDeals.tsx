...
// ── Local buyer CTA mapping (no matchScore in Discover) ─────────────────────

const BUYER_CTA_MAP: Record<string, BuyerCtaState> = {
  dr_001: 'enter_deal_room',
  dr_002: 'coming_soon',
  dr_005: 'request_access',
  dr_006: 'access_pending',
}
...
interface DiscoverDealsProps {
  onOpenDealRoom: (dealId: string) => void
}

export default function DiscoverDeals({ onOpenDealRoom }: DiscoverDealsProps) {
  ...
  return (
    <div className="px-4 sm:px-6 py-5 space-y-5 max-w-[1600px] mx-auto min-w-0">
      ...
      {/* Deal Preview Modal — no matchScore */}
      <DealPreviewModal
        deal={previewDeal}
